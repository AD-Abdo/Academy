        ...
        <div class="table-responsive">
            <div class="pr-5 pl-5 cairo mb-4">
                <div class="input-group">
                    <input style="border-radius: 50px" wire:model="search" type="text" class="form-control text-center" aria-label="Username" aria-describedby="basic-name" placeholder="ابحث باسم المرحلة" autofocus>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    @else
                        <tr class="text-center delete">
                            <td colspan="4">
                                لا يوجد مراحل دراسية مضافة حتي الان
                            </td>
                        </tr>
                    @endif
