            ...
            <div class="pr-5 pl-5 cairo mb-4">
                <div class="row">
                    <div class="col-md-3 m-0">
                        <form  wire:submit.prevent="updateAttendance"  class="input-group">
                            <input  style="border-radius: 50px" wire:model="attendance" type="text" class="form-control text-center" aria-label="Username" aria-describedby="basic-name" placeholder="فحص الكارت" autofocus>
                        </form>
                    </div>
                    <div class="col-md-3 m-0">
