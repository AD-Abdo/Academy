<div class="card" id="teachers-all">
        ...
        <div class="table-responsive">
            <div class="pr-5 pl-5 cairo mb-4">
                <div class="input-group">
                    <input style="border-radius: 50px" wire:model="search" type="text" class="form-control text-center" aria-label="Username" aria-describedby="basic-name" placeholder="ابحث باسم المدرس" autofocus>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    @else
                        <tr class="text-center delete">
                            <td colspan="5">
                                لا يوجد مدرسين مضافين حتي الان
                            </td>
                        </tr>
                    @endif
