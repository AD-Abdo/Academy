        ...
        <div class="pr-5 pl-5 cairo mb-4">
            <div class="row">
                ...
                <div class="col-md-3 m-0">
                    ...
                    <select  data-pharaonic="select2" data-component-id="{{ $this->id }}" data-dir="rtl" data-language="ar" data-search-on data-placeholder="اختر الطالب"
                        wire:model="student" name="student" class="form-control cairo js-example-disabled-results cairo" aria-label="Username" aria-describedby="basic-selectedTeachers">
                        <option value="" class="cairo input-group-text" selected >اختر الطالب</option>

                        @foreach ($students as $student)
                        <option value="{{ $student->id }}" class="cairo input-group-text">{{ $student->name }}</option>
                       @endforeach
                ...
                <div class="col-md-3 m-0">
                    <div   class="input-group">
                        <input  style="border-radius: 50px" wire:change="changeDate($e.target.value)" wire:model="date" type="month" class="form-control text-center" aria-label="Username" aria-describedby="basic-name" placeholder="الشهر">
                    </div>
                </div>
