...
@section('title', 'تسجيل الدخول الي النظام')
...
<div class="login-wrapper">
    <div class="container">
            ...
            <div class="loginbox pt-0">
                <img class="img-fluid mb-2" style="height: 400px;border-top-right-radius:5px;border-top-left-radius:5px" width="100%" src="{{ URL::asset('assets/img/abnKhaldon.jfif') }}" alt="Logo">
                ...
                <div class="login-right mt-0 pt-0">
                    ...
                    <div class="login-right-wrap mt-0 pt-0">
                        <form action="{{ URL::route('signIn') }}" method="POST">
                            ...
                            <button class="btn btn-lg btn-block btn-primary w-100 mt-3" style="font-size: 1em;" type="submit">تسجيل الدخول</button>
