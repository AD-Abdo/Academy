...
class CreateStudentSalarySubjectsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_salary_subjects', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('salary');
            $table->foreign('salary')->on('student_salaries')->references('id')->onDelete('CASCADE')->onUpdate('CASCADE');
    ...
    {
        Schema::dropIfExists('student_salary_subjects');
    }
}
